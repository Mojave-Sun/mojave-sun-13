...
/obj/machinery/shower/deconstruct(disassembled = TRUE)
	new /obj/item/stack/sheet/ms13/scrap(drop_location(), 1) //MOJAVE EDIT - Drops our scrap metal. Revert after CAT. // GOMBLE Notes - Should we just make some path macros?
	if(has_water_reclaimer)
