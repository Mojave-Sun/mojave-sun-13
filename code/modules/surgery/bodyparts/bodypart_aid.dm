...
/datum/bodypart_aid
	...
	var/overlay_prefix
	/// Verb for description. Bodypart is [desc_prefix] with [get_description()]
	var/desc_prefix
...
/**
 * get_description() called rip_off()
 *
...
/datum/bodypart_aid/splint/is_pristine()
	//Change this when you implement sling_condition
	return FALSE
