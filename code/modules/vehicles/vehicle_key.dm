...
/obj/item/key/janitor/suicide_act(mob/living/carbon/user)	//Holy shit, look at that janny go!
...
/obj/item/key/proc/manual_suicide(mob/living/user)
	if(user)
		...
		playsound(src, 'sound/effects/adminhelp.ogg', 50, TRUE, -1)	//Janny janny janny janny janny
