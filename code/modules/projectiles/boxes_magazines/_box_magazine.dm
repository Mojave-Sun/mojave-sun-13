...
/obj/item/ammo_box/attackby(obj/item/A, mob/user, params, silent = FALSE, replace_spent = 0)
	...
	if(!can_load(user))
		return
	if(istype(src, /obj/item/ammo_box/magazine/ammo_stack) || \
		istype(A, /obj/item/ammo_box/magazine/ammo_stack) || istype(A, /obj/item/ammo_box/ms13/stripper)) // MOJAVE SUN EDIT | INITIAL CODE : if(istype(A, /obj/item/ammo_box))
