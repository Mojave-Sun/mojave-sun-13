...
/mob/living/carbon/human/proc/generate_death_examine_text()
	...
	if(key || !getorgan(/obj/item/organ/brain) || ghost?.can_reenter_corpse)
		return span_deadsay("[t_He] [t_is] limp and unresponsive; there are no signs of life...") //MOJAVE SUN EDIT - TG Fluff Removal, yes I ran into this randomly and decided to change it, call the atomization
