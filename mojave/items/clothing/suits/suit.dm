...
/obj/item/clothing/suit/ms13/vest/brown
	...
	armor = list(melee = 20, bullet = 15, laser = 5, energy = 5, bomb = 5, bio = 5, rad = 5, fire = 5, acid = 5, wound = 0)
...
/obj/item/clothing/suit/ms13/veteran_coat
	...
	inhand_icon_state = "leatherjacket"
	armor = list(melee = 15, bullet = 20, laser = 5, energy = 5, bomb = 5, bio = 5, rad = 5, fire = 5, acid = 5, wound = 0)
...
/obj/item/clothing/suit/ms13/trench/black/armored
	...
	armor = list(melee = 50, bullet = 40, laser = 30, energy = 30, bomb = 40, bio = 20, rad = 20, fire = 50, acid = 20, wound = 10)
