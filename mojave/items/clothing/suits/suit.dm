...
/obj/item/clothing/suit/ms13/trench/black/armored
	...
	armor = list(melee = 50, bullet = 40, laser = 35, energy = 25, bomb = 40, bio = 20,  fire = 50, acid = 20, wound = 10)
...
/obj/item/clothing/suit/ms13/trench/battle
	...
	armor = list(melee = 35, bullet = 25, laser = 10, energy = 10, bomb = 20, bio = 10,  fire = 10, acid = 10)
