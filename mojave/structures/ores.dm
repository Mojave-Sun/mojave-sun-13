...
/obj/structure/ms13/ore_deposit/attackby(obj/item/pickaxe/ms13/W, mob/user)
	if(W.tool_behaviour)
...
/obj/structure/ms13/ore_deposit/copper
	...
	icon = 'mojave/icons/objects/crafting/ms_ores.dmi'
...
/turf/open/floor/plating/ms13/ground/mountain/proc/make_deposits(mapload)
	//var/Weight = 0
