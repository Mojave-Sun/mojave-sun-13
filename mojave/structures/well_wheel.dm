...
/obj/structure/ms13/well/Initialize()
	...
	create_reagents(10000, OPENCONTAINER | REFILLABLE)
...
/obj/structure/ms13/well/process()
	...
	reagents.add_reagent(/datum/reagent/water, max((1 / SECONDS_OF_LIFE_PER_WATER_U) * 10, (((1 / SECONDS_OF_LIFE_PER_WATER_U) * 2 * water_ratio * alive_humans) / length(GLOB.water_wells_in_world))))
