...
#define DESERT_LUSH_PLANT_SPAWN_LIST list(/obj/structure/flora/ms13/tree/drought/dead = 2, /obj/structure/flora/ms13/cactus = 2.5, /obj/structure/flora/ms13/cactus/tall = 2.5, /obj/structure/flora/ms13/leafy = 1, /obj/structure/ms13/turfdecor/drought = 10, /obj/structure/flora/ms13/forage/xander/drought = 1, /obj/structure/flora/ms13/forage/brocflower/drought = 1, /obj/structure/flora/ms13/forage/ashrose = 1, /obj/structure/flora/ms13/forage/aster/drought = 1, /obj/structure/flora/ms13/forage/yucca = 1, /obj/structure/flora/ms13/forage/barrel_cactus = 1)
