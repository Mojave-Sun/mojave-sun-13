...
#define SMOOTH_GROUP_MS13_CARPET_VIOLET S_OBJ_FO(19)			////turf/open/floor/wood/ms13/carpet/violet
#define SMOOTH_GROUP_MS13_CARPET_SHAGGY_RED S_OBJ_FO(20)		////turf/open/floor/wood/ms13/carpet/green
#define SMOOTH_GROUP_MS13_CARPET_SHAGGY_BLUE S_OBJ_FO(21)		////turf/open/floor/wood/ms13/carpet/green
#define SMOOTH_GROUP_MS13_CARPET_SHAGGY_GREEN S_OBJ_FO(22)		////turf/open/floor/wood/ms13/carpet/green
#define SMOOTH_GROUP_MS13_CARPET_SHAGGY_VIOLET S_OBJ_FO(23)		////turf/open/floor/wood/ms13/carpet/green
#define SMOOTH_GROUP_MS13_ROOF_NORMAL S_OBJ_FO(24)			////turf/open/floor/plating/roof
#define SMOOTH_GROUP_MS13_ROOF_SHEET S_OBJ_FO(25)			////turf/open/floor/plating/roof/sheet
#define SMOOTH_GROUP_MS13_ROOF_METAL S_OBJ_FO(26)			////turf/open/floor/plating/roof/metal
#define SMOOTH_GROUP_MS13_ROOF_WOOD S_OBJ_FO(27)			////turf/open/floor/plating/roof/wood

#define SMOOTH_GROUP_SOIL S_OBJ_FO(28)					///obj/machinery/hydroponics/ms13/soil
#define SMOOTH_GROUP_MS13_TABLE_METAL S_OBJ_FO(29)			///obj/structure/table/ms13
#define SMOOTH_GROUP_MS13_TABLE_WOOD S_OBJ_FO(30)			///obj/structure/table/ms13/wood
#define SMOOTH_GROUP_MS13_TABLE_SMALL S_OBJ_FO(31)			///obj/structure/table/ms13/metal/small
#define SMOOTH_GROUP_MS13_TABLE_PLAYER S_OBJ_FO(32) 	 	///obj/structure/table/ms13/metal/cobbled
