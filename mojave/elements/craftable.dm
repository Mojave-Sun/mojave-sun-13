...
/atom/proc/StartCraftingAtom(mob/living/user, obj/item/I, list/current_crafting_option)
	...
	soundloop.start()
	if(do_after_interactive(user, current_crafting_option[CRAFTING_TIME], thing, bonus_time = current_crafting_option[CRAFTING_TIME], focus_sound = pick(current_crafting_option[CRAFTING_FOCUS_SOUND]), type = current_crafting_option[CRAFTING_FOCUS_TYPE]))
...
/obj/item/ms13/crafting/gunpart/MakeCraftable()
	AddElement(/datum/element/craftable, /obj/item/ms13/crafting/other, /obj/item/gun/ballistic/rifle/ms13/varmint, 1, 120 SECONDS)
