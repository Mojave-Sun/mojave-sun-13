...
/obj/effect/abstract/displacement_map
	...
	icon = 'mojace/icons/effects/distortion/distort.dmi'
...
/obj/effect/abstract/displacement_map/Initialize(mapload, atom/new_owner)
	. = ..()
...
/obj/effect/abstract/displacement_map/proc/set_owner(atom/new_owner)
	if(owner)
		owner = null
		remove_displacement()
	if(!new_owner)
...
/obj/effect/abstract/displacement_map/proc/apply_displacement(atom/applied)
...
/obj/effect/abstract/displacement_map/proc/remove_displacement(atom/removed)
