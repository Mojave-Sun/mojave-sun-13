...
/obj/effect/spawner/random/power_armor
	name = "Random power_armor"
	spawn_loot_chance = 20
	loot = list(
		/obj/item/clothing/suit/space/hardsuit/ms13/power_armor/random
	)

/obj/effect/spawner/random/power_armor/frame
	name = "Frame PA"
...
/obj/effect/spawner/random/power_armor/t45
	name = "T45 PA"
...
/obj/effect/spawner/random/power_armor/t51
	name = "T51 PA"
	spawn_loot_chance = 15
	loot = list(
